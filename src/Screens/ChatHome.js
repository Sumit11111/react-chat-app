...
return (
	...
	<Paper style={left}>
		...
		<Divider />
        <div style={{display:"flex", justifyContent:"space-between", borderBottom:"0.5px solid grey"}}>
        <div>
            <h4 style={{fontSize:"13px", color:"grey"}}>CONVERSATIONS</h4>
        </div>
        <div>
            <img alt="add convo logo" style={{height:"25px",width:"25px",marginTop:"18px"}} src="https://cdn-icons-png.flaticon.com/128/1828/1828817.png"></img>
        </div>
    </div>
		 
        <SearchBar contacts={users}/>
